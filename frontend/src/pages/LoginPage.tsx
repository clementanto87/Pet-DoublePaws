                    ...
                    <CardContent className="p-6 sm:p-10">
                        ...
                        <div className="text-center mb-7">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-display font-extrabold tracking-tight text-slate-900 dark:text-white">
                                {t('auth.loginWelcome', 'Welcome to Double Paws')}
                            </h1>
                        </div>
                        ...
                        {/* Top Social Logins (Google, Facebook, Apple) */}
                        ...
                        <form className="space-y-4 sm:space-y-5" onSubmit={handleLogin}>
                            <div>
                                ...
                                <div className="mt-1.5">
                                    <Input
                                        ...
                                        autoComplete="email"
                                        required
                                        placeholder={t('auth.emailPlaceholder', 'E-mail')}
                            ...
                            <div className="pt-2">
                                <Button
                                    ...
                                    disabled={isLoading}
                                >
                                    {isLoading ? t('auth.signingIn', 'Signing in...') : t('navigation.login', 'Log in')}
                                </Button>
                            </div>
                        </form>
