...
const SitterDashboard: React.FC = () => {
    ...
    // Booking list controls are kept above the query so every change requests a fresh page.
    ...
    const upcomingBookings = activeTab === 'upcoming' ? bookings : [];
    const historicalBookings = activeTab === 'history' ? bookings : [];
    const displayedBookings = bookings;
    const filteredBookings = displayedBookings;
